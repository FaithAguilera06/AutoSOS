#!/usr/bin/env python3
"""
Correct Retraining Script for NewDatasets with Exact Folder Names
"""
...
def process_newdatasets_correct():
    """Process the NewDatasets with correct folder names"""
    print("Processing NewDatasets with Correct Folder Names...")
    ...
    # Correct folder name mapping (exact names from your folder)
    class_mapping = {
        'broken_headlights_tail_lights': 'broken_headlights_tail_lights',
...
def prepare_training_dataset():
    ...
    for class_name in class_names:
        ...
        images = list(class_dir.glob("*.jpg")) + list(class_dir.glob("*.png")) + list(class_dir.glob("*.jpeg")) + list(class_dir.glob("*.avif"))
...
def main():
    """Main function"""
    print("Correct NewDatasets Retraining Script")
    print("=" * 40)
    
    # Step 1: Process NewDatasets with correct folder names
    process_newdatasets_correct()
